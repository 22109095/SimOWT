...
def select_pos_neg(ref_box, all_indices, targets, det_targets, embed_head, hs_key, hs_ref, ref_cls, reid_depth=False, src_info_key=None, src_info_ref=None):
    ...
    if reid_depth:
        ...
        ref_embeds = embed_head[1](embed_head[0](
            ...
            src_info_ref["src_valid_ratios"], src_info_ref["src_padding_mask"], reid_depth=reid_depth))
        key_embedds = embed_head[1](embed_head[0](
            ...
            src_info_key["src_valid_ratios"], src_info_key["src_padding_mask"], reid_depth=reid_depth))
        a = 1
    else:
    ...
    for bz_i,(v,detv, indices) in enumerate(zip(targets,det_targets,all_indices)):
        ...
        for item1 in contrastive_pos[0]:
            if item1==None:
                matched[bz_i].append(False)
            else:
                matched[bz_i].append(True)
