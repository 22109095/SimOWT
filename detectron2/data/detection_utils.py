...
def read_image(file_name, format=None):
    ...
    try:
        ...
        file_name = '/ssd1/wby_workspace/tao30/' + file_name
        with PathManager.open(file_name, "rb") as f:
            image = Image.open(f)
...
def annotations_to_instances(annos, image_size, mask_format="polygon", transflow=None):
    """
    ...
    target.gt_classes = classes  # [ATTN]
